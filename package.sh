...
tar --exclude="tests" --exclude=".git*" --exclude="cache" --exclude="schema" --exclude="vendor" --exclude="logs" --exclude="*.local.yml" --exclude=".sass-cache" --exclude="*.swp" --exclude="*.swo" -czf "${APPPKG}" .
